...
//                         console.log('Redis users in project:', redisUsers);
//
//                         for (const userId of userIds) {
...
//                         done(err);
//                     }
//                 } else if (onlineEventsReceived > users.length) {
//                     done(new Error('Received more online events than expected'));
//                 }
//             });
//
...
//                 client.disconnect();
//             }, 300); // allow time to join and be registered in Redis
//         });
//
...
//                     done(err);
//                 }
//             }, 300); // wait a bit before reading from Redis
//         });
//
//         client.on('connect_error', (err) => {
